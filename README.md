...
In this project the data required by the user is fetched from all available sheets in a single workbook and is written in a Master Sheet which is in the same workbook. 
The data is also represented as a Bar Chart and added into the same Master Sheet.
